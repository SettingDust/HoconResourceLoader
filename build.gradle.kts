...
group = "settingdust.hoconresourceloader"
...
dependencies {
    ...
    include(catalog.typesafe.config)
    implementation(catalog.typesafe.config)
}
...
val metadata =
    mapOf(
        ...
        "source" to "https://github.com/SettingDust/HoconResourceLoader",
        "minecraft" to "~1.21",
